...
//        name += " \\W$ ";
    ...
    {
//        return "Welcome to the SGDB Shell! Enter 'help' for a list of commands. " +
//                "Please note that sgdb-shell is deprecated and to be replaced by cypher-shell.";
        return "Welcome to the SGDB Shell! ";
    }
