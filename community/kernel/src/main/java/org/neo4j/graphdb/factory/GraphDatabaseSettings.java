...
//    public static final Setting<String> active_database = setting( "dbms.active_database", STRING, "graph.db11" );
    public static final Setting<String> active_database = setting( "dbms.active_database", STRING, "sgdb_database" );
